...
knitr::include_graphics(here::here("data_files/plotlypdf/pf.png"))
```
...
```{r, eval = TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $f' = \\{f'_e\\}_{e\\in\\mathcal{E}}$ given by $f'_{e_1}(t) = 4t^3$ and $f'_{e_2}(t) = 4(t+\\ell_1)^3$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/pdf.png"))
```
...
```{r, eval = TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $f'' = \\{f''_e\\}_{e\\in\\mathcal{E}}$ given by $f''_{e_1}(t) = 12t^2$ and $f''_{e_2}(t) = 12(t+\\ell_1)^2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/pddf.png"))
```
...
```{r, eval = TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $f''' = \\{f'''_e\\}_{e\\in\\mathcal{E}}$ given by $f'''_{e_1}(t) = 24t$ and $f'''_{e_2}(t) = 24(t+\\ell_1)$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/pdddf.png"))
```
...
knitr::include_graphics(here::here("data_files/plotlypdf/pf3.png"))
```
...
```{r, eval= TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $g' = \\{g'_e\\}_{e\\in\\mathcal{E}}$ given by $g'_{e_1}(\\tau) = 4\\tau^3$ and $g'_{\\hat{e}_2}(\\tau) = 4(\\tau-(\\ell_1+\\ell_2))^3$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/pdf3.png"))
```
...
```{r, eval= TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $g'' = \\{g''_e\\}_{e\\in\\mathcal{E}}$ given by $g''_{e_1}(\\tau) = 12\\tau^2$ and $g''_{\\hat{e}_2}(\\tau) = 12(\\tau-(\\ell_1+\\ell_2))^2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/pddf3.png"))
```
...
```{r, eval= TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $g''' = \\{g'''_e\\}_{e\\in\\mathcal{E}}$ given by $g'''_{e_1}(\\tau) = 24\\tau$ and $g'''_{\\hat{e}_2}(\\tau) = 24(\\tau-(\\ell_1+\\ell_2))$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/pdddf3.png"))
```
...
```{r}
save_plotly_figure_fixed(pf, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(pdf, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(pddf, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(pdddf, dpi = 600,  scale = 2, viewer_change = 1)

save_plotly_figure_fixed(pf3, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(pdf3, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(pddf3, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(pdddf3, dpi = 600,  scale = 2, viewer_change = 1)

save_plotly_figure_fixed(pf_aux, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(pdf_aux, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(pddf_aux, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(pdddf_aux, dpi = 600,  scale = 2, viewer_change = 1)

png_files <- c("/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pf.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pf_aux.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pf3.png")
output_file <- "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pf_pf_aux_pf3.png"

combine_pngs_with_gap(png_files, output_file, gap = 200)


png_files <- c("/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pf.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pdf.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pddf.png")
output_file <- "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pf_pdf_pddf.png"

combine_pngs_with_gap(png_files, output_file, gap = 200)


png_files <- c("/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pf3.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pdf3.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pddf3.png")
output_file <- "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pf3_pdf3_pddf3.png"
...
knitr::include_graphics(here::here("data_files/plotlypdf/pf_aux.png"))
```
...
knitr::include_graphics(here::here("data_files/plotlypdf/pdf_aux.png"))
```
...
knitr::include_graphics(here::here("data_files/plotlypdf/pddf_aux.png"))
```
...
knitr::include_graphics(here::here("data_files/plotlypdf/pdddf_aux.png"))
```
