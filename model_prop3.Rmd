...
```{r}
a = 2.8
msdwmf <- graph$plot_function(X = std_expensive, vertex_size = 1, type = "plotly", line_color = "darkgreen", line_width = 7, edge_color = "black", edge_width = 7) %>% # true one
  graph$plot_function(X = std_cheap, p = ., vertex_size = 1, type = "plotly", line_color = "#0000C8", line_width = 7, edge_color = "black", edge_width = 7) %>% # approx one
  config(mathjax = 'cdn') %>% 
...
msdvswmf <- graph$plot_function(X = nonstat_est_sigma, vertex_size = 1, type = "plotly", line_color = "darkgreen", line_width = 7, edge_color = "black", edge_width = 7) %>%  
  config(mathjax = 'cdn') %>% 
...
```{r}
msdwmf_fem <- graph_copy2$plot_function(X = est_sigma_s, vertex_size = 1, type = "plotly", line_color = "#0000C8", line_width = 7, edge_color = "black", edge_width = 7) %>% 
  config(mathjax = 'cdn') %>% 
  layout(title = list(text = TeX("\\sigma_{\\kappa}(\\cdot)"), y = 0.8),
         font = list(family = "Palatino"),
         showlegend = FALSE,
...
msdvswmf_fem <- graph_copy2$plot_function(X = est_sigma_0, vertex_size = 1, type = "plotly", line_color = "darkgreen", line_width = 7, edge_color = "black", edge_width = 7) %>%  
  config(mathjax = 'cdn') %>% 
  layout(title = list(text = TeX("\\sigma_0"), y = 0.8),
         font = list(family = "Palatino"),
         showlegend = FALSE,
