...
```{r, eval = TRUE, fig.dim = c(9.22,4.01), fig.cap = captioner("MSE and negative Log-Score as functions of distance.")}
knitr::include_graphics(here::here("data_files/cv_sim.png"))
```
