...
p_neig_2 <- graph$plot(vertex_size = 0) +
  ...
  coord_fixed()
p_neig_2_plotly <- plotly::ggplotly(p_neig_2)
save(p_neig_2_plotly, file = here::here("data_files/cv_groups_plot.RData"))
myggsave(p_neig_2, width = 9.2, height = 4.01)
```
...
knitr::include_graphics(here::here("data_files/tikzpic/p_neig_2_with_mathpazo.png"))
```
...
knitr::include_graphics(here::here("data_files/tikzpic/combined_plot_with_mathpazo.pdf"))
```
