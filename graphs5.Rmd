...
save(phkok, file = here::here("data_files/h_kirchhoff.RData"))
save(pdhkok, file = here::here("data_files/dh_kirchhoff.RData"))
save(pddhkok, file = here::here("data_files/ddh_kirchhoff.RData"))
save(pdddhkok, file = here::here("data_files/dddh_kirchhoff.RData"))

```


```{r}
save_plotly_figure_fixed(phkok, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(pdhkok, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(pddhkok, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(pdddhkok, dpi = 600,  scale = 2, viewer_change = 1)

png_files <- c("/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/phkok.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pdhkok.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pddhkok.png")
output_file <- "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/phkok_pdhkok_pddhkok.png"
...
knitr::include_graphics(here::here("data_files/plotlypdf/phkok.png"))
```
...
knitr::include_graphics(here::here("data_files/plotlypdf/pdhkok.png"))
```
...
knitr::include_graphics(here::here("data_files/plotlypdf/pddhkok.png"))
```
...
knitr::include_graphics(here::here("data_files/plotlypdf/pdddhkok.png"))
```
...
```{r}
save_plotly_figure_fixed(pfkirok, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(pdfkirok, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(pddfkirok, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(pdddfkirok, dpi = 600,  scale = 2, viewer_change = 1)

png_files <- c("/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pfkirok.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pdfkirok.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pddfkirok.png")
output_file <- "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pfkirok_pdfkirok_pddfkirok.png"
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $h = \\{h_e\\}_{e\\in\\mathcal{E}}$ given by $h_{e_i}(s) = a + b_i s - \\dfrac{b_i s^3}{3\\ell^2}$ for $i=1,2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/pfkirok.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $h' = \\{h'_e\\}_{e\\in\\mathcal{E}}$ given by $h'_{e_i}(s) = b_i - \\dfrac{b_i s^2}{\\ell^2}$ for $i=1,2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/pdfkirok.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $h'' = \\{h''_e\\}_{e\\in\\mathcal{E}}$ given by $h''_{e_i}(s) =  - \\dfrac{2 b_i s}{\\ell^2}$ for $i=1,2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/pddfkirok.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $h''' = \\{h'''_e\\}_{e\\in\\mathcal{E}}$ given by $h'''_{e_i}(s) =  - \\dfrac{2 b_i}{\\ell^2}$ for $i=1,2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/pdddfkirok.png"))
```
...
save(pf_aux2, file = here::here("data_files/pf_aux2.Rdata"))
save(pdf_aux2, file = here::here("data_files/pdf_aux2.Rdata"))
save(pddf_aux2, file = here::here("data_files/pddf_aux2.Rdata"))
save(pdddf_aux2, file = here::here("data_files/pdddf_aux2.Rdata"))
```


```{r}
save_plotly_figure_fixed(pf_aux2, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(pdf_aux2, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(pddf_aux2, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(pdddf_aux2, dpi = 600,  scale = 2, viewer_change = 1)

png_files <- c("/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pf_aux2.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pdf_aux2.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pddf_aux2.png")
output_file <- "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/pf_aux2_pdf_aux2_pddf_aux2.png"
...
```{r, eval = TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $f = \\{f_e\\}_{e\\in\\mathcal{E}}$ given by $f_{e_1}(t) = t^4$ and $f_{e_2}(t) = (t+\\ell_1)^4$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/phkok.png"))
```
...
```{r, eval = TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $\\hat{f} = \\{f_e\\}_{e\\in\\mathcal{E}}$ given by $f_{e_1}(t) = t^4$ and $f_{\\hat{e}_2}(t) = (t+\\ell_1)^4$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/pf_aux2.png"))
```
...
```{r, eval= TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $g = \\{g_e\\}_{e\\in\\mathcal{E}}$ given by $g_{e_1}(\\tau) = \\tau^4$ and $g_{\\hat{e}_2}(\\tau) = (\\tau-(\\ell_1+\\ell_2))^4$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/pfkirok.png"))
```
...
```{r, eval = TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $\\hat{f}' = \\{f'_e\\}_{e\\in\\mathcal{E}}$ given by $f'_{e_1}(t) = 4t^3$ and $f'_{\\hat{e}_2}(t) = 4(t+\\ell_1)^3$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/pdf_aux2.png"))
```
...
```{r, eval = TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $\\hat{f}'' = \\{f''_e\\}_{e\\in\\mathcal{E}}$ given by $f''_{e_1}(t) = 12t^2$ and $f''_{\\hat{e}_2}(t) = 12(t+\\ell_1)^2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/pddf_aux2.png"))
```
...
```{r, eval = TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $\\hat{f}''' = \\{f'''_e\\}_{e\\in\\mathcal{E}}$ given by $f'''_{e_1}(t) = 24t$ and $f'''_{\\hat{e}_2}(t) = 24(t+\\ell_1)$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/pdddf_aux2.png"))
```
