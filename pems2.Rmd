...
knitr::include_graphics(here::here("data_files/tikzpic/p_neig_with_mathpazo.png"))
```
...
knitr::include_graphics(here("data_files/tikzpic/combined_plot_pems_with_mathpazo.pdf"))
```
