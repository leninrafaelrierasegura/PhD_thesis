...
layout_int <- list(xaxis = list(title = list(text = "x", font = list(color = "gray")),  tickfont = list(color = "gray")),
...
notes1 <- list(annotations = list(
                   ...
                   list(
                     ...
                     font = list(color = "rgb(0,0,200)", size = 16),
                     arrowcolor = "rgba(0,0,0,0)")))
...
p2 <- plot_ly() |> 
  ...
  add_trace(data = df3, x = ~x, y = ~y, z = ~z, mode = "markers", type = "scatter3d", 
            marker = list(size = 5, color = "gray", symbol = 104)) |>
  add_trace(x = 0, y = 0, z = 0, mode = "markers", type = "scatter3d", 
            marker = list(size = 5, color = "black", symbol = 104),
            showlegend = FALSE) |>
  add_trace(x = 1, y = 0, z = 0, mode = "markers", type = "scatter3d", 
...
p3 <- plot_ly() |> 
  ...
  add_trace(x = rep(x, times = ncol(A) - graph$nV), 
            ...
            type = "scatter3d",
            mode = "lines", 
            line = list(color = "darkgray", width = 5), 
            showlegend = FALSE) |>
  add_trace(x = rep(x, each = 3), 
            y = rep(y, each = 3), 
  ...
  add_trace(x = df4[5,1], y = df4[5,2], z = 0, mode = "markers", type = "scatter3d", 
            marker = list(size = 5, color = "rgb(0,0,200)", symbol = 104),
            showlegend = FALSE) |>
  add_trace(x = 0, y = 0, z = 0, mode = "markers", type = "scatter3d", 
            marker = list(size = 5, color = "black", symbol = 104),
            showlegend = FALSE) |>
