---
title: "Simplest graphs and more"
...
```{r}
capture.output(
  knitr::purl(here::here("functionality1.Rmd"), 
              output = here::here("functionality1.R")),
...
p11 <- graph$plot_function(rep(0,nrow(graph$mesh$V)), 
  ...
  layout(font = list(family = "Palatino"),
         scene =  list(
           xaxis = list(title = list(text = "x", font = list(color = "gray", size = 20)),  tickfont = list(color = "gray", size = 15), range = c(-0.5,0.5)),
              yaxis = list(title = list(text = "y", font = list(color = "gray", size = 20)),  tickfont = list(color = "gray", size = 15)),
              zaxis = list(title = list(text = "z", font = list(color = "gray", size = 20)),  tickfont = list(color = "gray", size = 15), range = c(-0.5,0.5)),
  camera = list(eye = list(x = 2.1, y = 2.1, z = 2.1),
                            center = list(x = 0, 
                                          y = 0, 
                                          z = 0)),
...
p11new <- graph$plot_function(rep(0,nrow(graph$mesh$V)), 
  ...
  layout(font = list(family = "Palatino"),
         scene =  list(
           xaxis = list(title = list(text = "x", font = list(color = "gray", size = 20)),  tickfont = list(color = "gray", size = 15)),
              yaxis = list(title = list(text = "y", font = list(color = "gray", size = 20)),  tickfont = list(color = "gray", size = 15)),
              zaxis = list(title = list(text = "z", font = list(color = "gray", size = 20)),  tickfont = list(color = "gray", size = 15), range = c(-0.5,0.5)),
  camera = list(eye = list(x = 2.1, y = 2.1, z = 2.1),
                            center = list(x = 0, 
...
save(p_int_dir_der, file = here::here("data_files/interval_graph_derivative.Rdata"))
```
...
p1 <- plot_ly() |> 
  ...
  layout(font = list(family = "Palatino"),
         scene = list(
           xaxis = list(title = list(text = "x", font = list(color = "gray", size = 20)),  tickfont = list(color = "gray", size = 15), range = x_range),
           ...
           annotations = list(
                   ...
                   list(
                     ...
                     font = list(color = "rgb(0,0,200)", size = 20),
                     arrowcolor = "rgba(0,0,0,0)"))
         ),
         margin = list(l = 0, r = 0, b = 0, t = 0),
         showlegend = FALSE,
...
\begin{equation*}
    ...
    \end{cases}
\end{equation*}
where $x_v^e$ is either $x_0^e$ or $x_{n_e}^e$ depending on the edge direction and its parameterization. See [@Arioli2018AFinite] for more. Figure 3 below provides an illustration of the system of basis functions $\{\varphi_j^e, \phi_v\}$ together with the set $\Ncal_v$.
...
```{r, eval = FALSE}
save_plotly_figure_fixed(p11, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(p22, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(p33, dpi = 600,  scale = 2, viewer_change = 1)
png_files <- c("/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p11.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p22.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p33.png")
output_file <- "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p11_p22_p33.png"
combine_pngs_with_gap(png_files, output_file, gap = 200)


save_plotly_figure_fixed(p1, dpi = 600,  scale = 2, viewer_change = 1)



save_plotly_figure_fixed(p2, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(p3, dpi = 600,  scale = 2, viewer_change = 1)
png_files <- c("/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p2.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p3.png")
output_file <- "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p2_p3.png"
combine_pngs_with_gap(png_files, output_file, gap = 200)


save_plotly_figure_fixed(p11new, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(p2int, dpi = 600,  scale = 2, viewer_change = 1)
png_files <- c("/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p11new.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p2int.png")
output_file <- "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p11new_p2int.png"
combine_pngs_with_gap(png_files, output_file, gap = 200)



save_plotly_figure_fixed(p_int_dir_der, dpi = 600,  scale = 2, viewer_change = 2)


save_plotly_figure_fixed(p_int_dir_der_exp, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(p_int_dir_der_exp_rev, dpi = 600,  scale = 2, viewer_change = 1)
png_files <- c("/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p_int_dir_der_exp.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p_int_dir_der_exp_rev.png")
output_file <- "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p_int_dir_der_exp_p_int_dir_der_exp_rev.png"
combine_pngs_with_gap(png_files, output_file, gap = 200)
```
...
:::: {style="display: grid; grid-template-columns: 600px 492px 628px; grid-column-gap: 0px;"}


::: {}

```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Interval graph $\\Gamma_I = (\\mathcal{V}, \\mathcal{E})$ with $\\mathcal{V} = \\{v_1, v_2\\}$ and $\\mathcal{E} = \\{e_1\\}$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/p11.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Circle graph $\\Gamma_C = (\\mathcal{V}, \\mathcal{E})$ with $\\mathcal{V} = \\{v_1\\}$ and $\\mathcal{E} = \\{e_1\\}$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/p22.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Tadpole graph $\\Gamma_T = (\\mathcal{V}, \\mathcal{E})$ with $\\mathcal{V} = \\{v_1, v_2\\}$ and $\\mathcal{E} = \\{e_1,e_2\\}$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/p33.png"))
```
...
:::: {style="display: grid; grid-template-columns: 600px 600px 600px; grid-column-gap: 0px;"}


::: {}

```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("A function $f=\\gamma\\big|_\\Gamma$ on the tadpole graph, where $\\gamma(x,y) = e^{-x^2-y^2}$, together with a path that illustrates the geodesic distance between points $s_1$ and $s_2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/p1.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Mesh nodes on the tadpole graph.")}
knitr::include_graphics(here::here("data_files/plotlypdf/p2.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Basis functions on the tadpole graph.")}
knitr::include_graphics(here::here("data_files/plotlypdf/p3.png"))
```
...
:::: {style="display: grid; grid-template-columns: 600px 600px 600px 600px 600px; grid-column-gap: 0px;"}


::: {}

```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Interval graph $\\Gamma_I = (\\mathcal{V}, \\mathcal{E})$ with $\\mathcal{V} = \\{v_1, v_2\\}$ and $\\mathcal{E} = \\{e_1\\}$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/p11new.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Interval graph $\\Gamma_I = (\\mathcal{V}, \\mathcal{E})$ with $\\mathcal{V} = \\{v_1, v_2\\}$ and $\\mathcal{E} = \\{e_1\\}$, where $e_1$ is flipped.")}
knitr::include_graphics(here::here("data_files/plotlypdf/p2int.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Interval graph $\\Gamma_I = (\\mathcal{V}, \\mathcal{E})$ with $\\mathcal{V} = \\{v_1, v_2\\}$ and $\\mathcal{E} = \\{e_1\\}$, where $e_1$ is flipped.")}
knitr::include_graphics(here::here("data_files/plotlypdf/p_int_dir_der.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Interval graph $\\Gamma_I = (\\mathcal{V}, \\mathcal{E})$ with $\\mathcal{V} = \\{v_1, v_2\\}$ and $\\mathcal{E} = \\{e_1\\}$, where $e_1$ is flipped.")}
knitr::include_graphics(here::here("data_files/plotlypdf/p_int_dir_der_exp.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Interval graph $\\Gamma_I = (\\mathcal{V}, \\mathcal{E})$ with $\\mathcal{V} = \\{v_1, v_2\\}$ and $\\mathcal{E} = \\{e_1\\}$, where $e_1$ is flipped.")}
knitr::include_graphics(here::here("data_files/plotlypdf/p_int_dir_der_exp_rev.png"))
```
