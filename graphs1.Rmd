...
```{r, eval =TRUE, fig.height = 7, out.width = "100%", fig.cap = captioner("Interval graph $\\Gamma_I = (\\mathcal{V}, \\mathcal{E})$ with $\\mathcal{V} = \\{v_1, v_2\\}$ and $\\mathcal{E} = \\{e_1\\}$.")}
...
```{r, eval =TRUE, fig.height = 7, out.width = "100%", fig.cap = captioner("Circle graph $\\Gamma_C = (\\mathcal{V}, \\mathcal{E})$ with $\\mathcal{V} = \\{v_1\\}$ and $\\mathcal{E} = \\{e_1\\}$.")}
...
```{r, eval =TRUE, fig.height = 7, out.width = "100%", fig.cap = captioner("Tadpole graph $\\Gamma_T = (\\mathcal{V}, \\mathcal{E})$ with $\\mathcal{V} = \\{v_1, v_2\\}$ and $\\mathcal{E} = \\{e_1,e_2\\}$.")}
...
```{r, eval =TRUE, fig.height = 7, out.width = "100%", fig.cap = captioner("A function $f=\\gamma\\big|_\\Gamma$ on the tadpole graph, where $\\gamma(x,y) = e^{-x^2-y^2}$, together with a path that illustrates the geodesic distance between points $s_1$ and $s_2$.")}
...
```{r, eval =TRUE, fig.height = 7, out.width = "100%", fig.cap = captioner("Basis functions on the tadpole graph.")}
...
:::: {style="display: grid; grid-template-columns: 485px 485px 485px 485px 485px; grid-column-gap: 0px;"}


::: {}

```{r, eval =TRUE, fig.height = 7, out.width = "100%", fig.cap = captioner("Interval graph $\\Gamma_I = (\\mathcal{V}, \\mathcal{E})$ with $\\mathcal{V} = \\{v_1, v_2\\}$ and $\\mathcal{E} = \\{e_1\\}$.")}
load(here::here("data_files/interval_graph_with_coordinates.Rdata"))
p11new
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "100%", fig.cap = captioner("Interval graph $\\Gamma_I = (\\mathcal{V}, \\mathcal{E})$ with $\\mathcal{V} = \\{v_1, v_2\\}$ and $\\mathcal{E} = \\{e_1\\}$, where $e_1$ is flipped.")}
...
```{r, eval =TRUE, fig.height = 7, out.width = "100%", fig.cap = captioner("Interval graph $\\Gamma_I = (\\mathcal{V}, \\mathcal{E})$ with $\\mathcal{V} = \\{v_1, v_2\\}$ and $\\mathcal{E} = \\{e_1\\}$, where $e_1$ is flipped.")}
load(here::here("data_files/interval_graph_derivative.Rdata"))
p_int_dir_der
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "100%", fig.cap = captioner("Interval graph $\\Gamma_I = (\\mathcal{V}, \\mathcal{E})$ with $\\mathcal{V} = \\{v_1, v_2\\}$ and $\\mathcal{E} = \\{e_1\\}$, where $e_1$ is flipped.")}
load(here::here("data_files/interval_graph_derivative_exp.Rdata"))
p_int_dir_der_exp
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "100%", fig.cap = captioner("Interval graph $\\Gamma_I = (\\mathcal{V}, \\mathcal{E})$ with $\\mathcal{V} = \\{v_1, v_2\\}$ and $\\mathcal{E} = \\{e_1\\}$, where $e_1$ is flipped.")}
load(here::here("data_files/interval_graph_derivative_exp_rev.Rdata"))
p_int_dir_der_exp_rev
```
