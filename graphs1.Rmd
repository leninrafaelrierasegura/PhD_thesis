...
```{r, eval = FALSE}
save_plotly_figure_fixed(p1, dpi = 600,  scale = 2, viewer_change = 0.74)
save_plotly_figure_fixed(p2, dpi = 600,  scale = 2, viewer_change = 0.74)
save_plotly_figure_fixed(p3, dpi = 600,  scale = 2, viewer_change = 0.74)

save_plotly_figure_fixed(p11, dpi = 600,  scale = 2, viewer_change = 0.8)
save_plotly_figure_fixed(p22, dpi = 600,  scale = 2, viewer_change = 0.8)
save_plotly_figure_fixed(p33, dpi = 600,  scale = 2, viewer_change = 1)

save_plotly_figure_fixed(p11new, dpi = 600,  scale = 2, viewer_change = 0.8)
save_plotly_figure_fixed(p2int, dpi = 600,  scale = 2, viewer_change = 0.8)

save_plotly_figure_fixed(p_int_dir_der, dpi = 600,  scale = 2, viewer_change = 2)

save_plotly_figure_fixed(p_int_dir_der_exp, dpi = 600,  scale = 2, viewer_change = 0.8)
save_plotly_figure_fixed(p_int_dir_der_exp_rev, dpi = 600,  scale = 2, viewer_change = 0.8)
```
