...
p_spaguetti <- graph$plot_function(X= fun$f, 
  ...
  layout(font = list(family = "Palatino"),
            ...
            scene = list(xaxis = list(title = list(text = "Latitude", font = list(color = colaxnn)),  tickfont = list(color = colaxnn),  range = range(xy_vertex[,2])),
              yaxis = list(title = list(text = "Longitude", font = list(color = colaxnn)),  tickfont = list(color = colaxnn), range = range(xy_vertex[,1])),
              zaxis = list(title = list(text = "", font = list(color = colaxnn)),  tickfont = list(color = colaxnn), range = c(0, max(fun$f, na.rm = TRUE))),
    aspectratio = list(x = 10, y = 10, z = 1),
    camera = list(eye = list(y = 37.34*rv, x = -121.87*rv, z = 100*rv),
