...
layout(font = list(family = "Palatino"),
            ...
            scene = list(
              xaxis = list(title = list(text = "Longitude", font = list(color = "gray", size = 22)),  
                           tickfont = list(color = "gray", size = 16),  range = x_range),
              yaxis = list(title = list(text = "Latitude", font = list(color = "gray", size = 22)),  
                           tickfont = list(color = "gray", size = 16), range = y_range),
              zaxis = list(title = list(text = "", font = list(color = "gray", size = 22)),  
                           tickfont = list(color = "gray", size = 16), range = c(0,z_range[2])),
...
save_plotly_figure_fixed(p_spaguetti3d, dpi = 600,  scale = 2, viewer_change = 1.4)
```
