...
p_spaguetti <- p12 +
  ...
  theme_minimal() + 
  theme(   
    text = element_text(family = "Palatino Linotype", size = 14, color = "black"),
...
# Save temporarily
ggsave(here::here("data_files/map_with_square.png"), plot = p_spaguetti, width = mywidth, height = myheight, dpi = 195)
...
layout(font = list(family = "Palatino Linotype"),
            ...
            scene = list(
              xaxis = list(title = list(text = "Longitude", font = list(color = "black", size = 16)),  
                           tickfont = list(color = "gray", size = 13.5),  range = x_range),
              yaxis = list(title = list(text = "Latitude", font = list(color = "black", size = 16)),  
                           tickfont = list(color = "gray", size = 13.5), range = y_range),
              zaxis = list(title = list(text = "", font = list(color = "black", size = 16)),  
                           tickfont = list(color = "gray", size = 13.5), range = c(0,z_range[1])),
    aspectratio = list(x = xxx, y = yyy, z = 1),
    camera = list(eye = list(y = -37.34*rv, x = 0*rv, z = 70*rv),
                            center = list(x = 0, y =-2.5, z = 0))
  )
)
...
#             margin = list(l = 0, r = 0, b = 0, t = 0),
#             scene = list(xaxis = list(title = list(text = "Longitude", font = list(color = "gray")),  tickfont = list(color = "gray"),  range = x_range),
#               yaxis = list(title = list(text = "Latitude", font = list(color = "gray")),  tickfont = list(color = "gray"), range = y_range),
#               zaxis = list(title = list(text = "", font = list(color = "gray")),  tickfont = list(color = "gray"), range = z_range),
...
save_plotly_figure_fixed(p_spaguetti3d, dpi = 65,  scale = 4, viewer_change = 1.4)
```
...
p_to_show_geodesic_dist <- graph$plot(vertex_size = 1, 
  ...
  scale_color_viridis_c(
    ...
    theme_minimal() + 
  theme(text = element_text(family = "Palatino Linotype", size = 14, color = "black"), 
        axis.text = element_text(size = 14),
...
ggsave(here::here("data_files/p_to_show_geodesic_dist.png"), plot = p_to_show_geodesic_dist, width = mywidth, height = myheight, dpi = 195)
```


```{r}
png_files <- c("/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p_spaguetti3d.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/map_with_square.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/p_to_show_geodesic_dist.png")
output_file <- "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p_spaguetti3d_map_with_square_p_to_show_geodesic_dist.png"
combine_pngs_with_gap(png_files, output_file, gap = 0)
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%"}
knitr::include_graphics(here::here("data_files/plotlypdf/p_spaguetti3d.png"))
```
