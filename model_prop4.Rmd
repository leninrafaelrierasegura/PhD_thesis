...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Discontinuous covariate $f(s) = \\mathrm{edge.number}(s)/4$.")}
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Continuous covariate $g(s) = 0.5 \\cdot (x^2(s) - y^2(s)) + 0.5$.")}
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Model for $\\tau(s)$.")}
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Model for $\\kappa(s)$.")}
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Simulated field $u(s)$.")}
...
```{r, echo = FALSE, eval =TRUE, fig.height = 7, out.width = "70%"}
knitr::include_graphics(here::here("data_files/plotlypdf/kkk10.png"))
```
...
```{r, echo = FALSE, eval =TRUE, fig.height = 7, out.width = "70%"}
knitr::include_graphics(here::here("data_files/plotlypdf/kkk11.png"))
```
...
```{r, echo = FALSE, eval =TRUE, fig.height = 7, out.width = "70%"}
knitr::include_graphics(here::here("data_files/plotlypdf/kkk12.png"))
```
