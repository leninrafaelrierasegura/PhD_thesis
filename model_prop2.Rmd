...
save_plotly_figure_fixed(p_B, dpi = 600,  scale = 2, viewer_change = 1)
```


```{r}
png_files <- c("/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p_A.png",
...
#load(here::here("data_files/3d_cov_plots_diff_nu.RData"))
...
knitr::include_graphics(here::here("data_files/plotlypdf/p_B.png"))
```
