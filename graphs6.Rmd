...
p2fhelix <- p |> config(mathjax = 'cdn') |>
            ...
            scene = list(xaxis = list(title = list(text = "x", font = list(color = "gray", size = 16)),  tickfont = list(color = "gray", size = 13),  range = c(0, L)),
              yaxis = list(title = list(text = "y", font = list(color = "gray", size = 16)),  tickfont = list(color = "gray", size = 13), range = c(-1, 4.1)),
              zaxis = list(title = list(text = "z", font = list(color = "gray", size = 16)),  tickfont = list(color = "gray", size = 13), range = c(-1, max(ff_eval))),
              #aspectmode="data",
...
rv <- 0.65
graphs6p2 <- p |> config(mathjax = 'cdn') |>
            layout(p,
                   font = list(family = "Palatino"),
            margin = list(l = 0, r = 0, b = 0, t = 0),
            scene = list(xaxis = list(title = list(text = "x", font = list(color = "gray", size = 16)),  tickfont = list(color = "gray", size = 13),  range = c(0, L)),
              yaxis = list(title = list(text = "y", font = list(color = "gray", size = 16)),  tickfont = list(color = "gray", size = 13), range = c(-1, 4.1)),
              zaxis = list(title = list(text = "z", font = list(color = "gray", size = 16)),  tickfont = list(color = "gray", size = 13), range = c(-1, 2)),
              #aspectmode="data",
...
save(graphs6p2, file = here::here("data_files/graphs6p2.Rdata"))
```
...
f1 <- function(s) exp(s/4)


f1_on_curve <- f1(s)
y_up_range <- max(f1_on_curve)

f2 <- function(s) sin(3*pi*s/L) + y_up_range
...
save(graphs6p4, file = here::here("data_files/graphs6p4.Rdata"))
```


```{r}
save_plotly_figure_fixed(p2fhelix, dpi = 300,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(graphs6p2, dpi = 300,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(p4tadpole_arclength, dpi = 300,  scale = 2, viewer_change = 1.01)
save_plotly_figure_fixed(graphs6p4, dpi = 600,  scale = 2, viewer_change = 1)
```


```{r, eval =TRUE, fig.height = 7, out.width = "40%"}
knitr::include_graphics(here::here("data_files/plotlypdf/p2fhelix.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "40%"}
knitr::include_graphics(here::here("data_files/plotlypdf/graphs6p2.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "40%"}
knitr::include_graphics(here::here("data_files/plotlypdf/p4tadpole_arclength.png"))
```



```{r, eval =TRUE, fig.height = 7, out.width = "40%"}
knitr::include_graphics(here::here("data_files/plotlypdf/graphs6p4.png"))
```
...
# ---- animation
p_from_graph_to_interval_transformation <- p |> animation_opts(
  frame = 60,
  transition = 0,
  redraw = TRUE
)

save_dual_for_presentation(p_from_graph_to_interval_transformation)
```
...
```{r, eval =TRUE, fig.height = 7, fig.cap = captioner("Animation.")}
