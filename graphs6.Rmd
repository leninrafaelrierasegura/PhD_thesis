...
```{r}
save_plotly_figure_fixed(p2fhelix, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(graphs6p2, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(p4tadpole_arclength, dpi = 600,  scale = 2, viewer_change = 1.01)
