...
knitr::include_graphics(here::here("data_files/tikzpic/p_err_int_with_mathpazo.pdf"))
```
...
knitr::include_graphics(here::here("data_files/tikzpic/p_err_cir_with_mathpazo.pdf"))
```
...
knitr::include_graphics(here::here("data_files/tikzpic/p_err_tad_with_mathpazo.pdf"))
```
