...
```{r}
star3f <- graph$plot_function(X = f, vertex_size = 5, edge_width = 5, line_width = 5, type = "plotly") |> 
  config(mathjax = 'cdn') |>
  add_trace(
  type = "cone",
  x = ym1,
  ...
  plotly::layout(title = list(text = TeX("f"), y = 0.8),
                 scene = list(xaxis = list(title = list(text = "x", font = list(color = "lightgray")),  tickfont = list(color = "lightgray")),
              yaxis = list(title = list(text = "y", font = list(color = "lightgray")),  tickfont = list(color = "lightgray")),
              zaxis = list(title = list(text = "z", font = list(color = "lightgray")),  tickfont = list(color = "lightgray")),
                   aspectratio = list(x = 2, 
                                 y = 2, 
                                 z = 2),
                   camera = list(eye = list(x = x_eye, 
...
star3df <- graph$plot_function(X = f*0, vertex_size = 5, line_color = "black", edge_width = 5, line_width = 5, type = "plotly") |>
  add_trace(
  type = "cone",
  x = ym1,
  y = xm1,
...
star3ddf <- graph$plot_function(X = ddf, vertex_size = 5, edge_width = 5, line_width = 5, continuous = TRUE, interpolate_plot = TRUE, type = "plotly") |> 
  add_trace(
  type = "cone",
  x = ym1,
  y = xm1,
...
star3dddf <- graph_disc$plot_function(X = dddf, vertex_size = 5, edge_width = 5, line_width = 5, continuous = FALSE, interpolate_plot = TRUE, type = "plotly") |> 
  add_trace(
  type = "cone",
  x = ym1,
  y = xm1,
...
```{r}
star3g <- graph$plot_function(X = g, vertex_size = 5, edge_width = 5, line_width = 5, type = "plotly") |> 
  config(mathjax = 'cdn') |>
  add_trace(
  type = "cone",
  x = ym1,
...
star3dg <- graph$plot_function(X = dg, vertex_size = 5, edge_width = 5, line_width = 5, type = "plotly") |> 
  config(mathjax = 'cdn') |>
  add_trace(
  type = "cone",
  x = ym1,
...
star3ddg <- graph$plot_function(X = ddg, vertex_size = 5, edge_width = 5, line_width = 5, type = "plotly") |> 
  config(mathjax = 'cdn') |>
  add_trace(
  type = "cone",
  x = ym1,
...
star3dddg <- graph$plot_function(X = dddg, vertex_size = 5, edge_width = 5, line_width = 5, type = "plotly") |> 
  config(mathjax = 'cdn') |>
  add_trace(
  type = "cone",
  x = ym1,
...
```{r}
star2f <- graph$plot_function(X = f, vertex_size = 5, edge_width = 5, line_width = 5, type = "plotly") |> 
  config(mathjax = 'cdn') |>
  add_trace(
  type = "cone",
  x = ym1,
...
star2df <- graph$plot_function(X = f*0, vertex_size = 5, line_color = "black", edge_width = 5, line_width = 5, type = "plotly") |>
  add_trace(
  type = "cone",
  x = ym1,
  y = xm1,
...
star2ddf <- graph$plot_function(X = ddf, vertex_size = 5, edge_width = 5, line_width = 5, type = "plotly") |> 
  config(mathjax = 'cdn') |>
  add_trace(
  type = "cone",
  x = ym1,
...
star2dddf <- graph_disc$plot_function(X = dddf, vertex_size = 5, edge_width = 5, line_width = 5, continuous = FALSE, interpolate_plot = TRUE, type = "plotly") |> 
  add_trace(
  type = "cone",
  x = ym1,
  y = xm1,
