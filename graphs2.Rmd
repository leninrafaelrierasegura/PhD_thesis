...
star3ddg_path1 <- graph$plot_function(X = ddg, vertex_size = gsw, edge_width = gsw, line_width = gsw, type = "plotly") |> 
  config(mathjax = 'cdn') |>
  add_trace(
  type = "cone",
  x = ym1,
...
star3ddg_path2 <- graph$plot_function(X = ddg, vertex_size = gsw, edge_width = gsw, line_width = gsw, type = "plotly") |> 
  config(mathjax = 'cdn') |>
  add_trace(
  type = "cone",
  x = ym1,
...
star3ddg_path3 <- graph$plot_function(X = ddg, vertex_size = gsw, edge_width = gsw, line_width = gsw, type = "plotly") |> 
  config(mathjax = 'cdn') |>
  add_trace(
  type = "cone",
  x = ym1,
