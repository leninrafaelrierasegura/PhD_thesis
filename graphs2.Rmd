...
graph_disc$plot_function(X = df, vertex_size = 5, edge_width = 5, line_width = 5, continuous = FALSE, interpolate_plot = TRUE, type = "plotly") |> 
  config(mathjax = 'cdn') |>
...
graph$plot_function(X = f, vertex_size = 5, edge_width = 5, line_width = 5, type = "plotly") |> 
  config(mathjax = 'cdn') |>
  add_trace(
  type = "cone",
  x = ym1,
  ...
  plotly::layout(title = list(text = TeX("f"), y = 0.8),
                 scene = list(xaxis = list(title = list(text = "x", font = list(color = "gray")),  tickfont = list(color = "gray")),
              yaxis = list(title = list(text = "y", font = list(color = "gray")),  tickfont = list(color = "gray")),
              zaxis = list(title = list(text = "z", font = list(color = "gray")),  tickfont = list(color = "gray")),
                   aspectratio = list(x = 2, 
                                 y = 2, 
                                 z = 2),
                   camera = list(eye = list(x = x_eye, 
...
```{r, eval =TRUE, fig.height = 7, out.width = "100%", fig.cap = captioner("Function $f' = \\{f'_e\\}_{e\\in\\mathcal{E}}$ given by $f_{e_i}'(s) = b_i - \\dfrac{b_i s^2}{\\ell^2}$ for $i=1,2,3$.")}
graph$plot_function(X = f*0, vertex_size = 5, line_color = "black", edge_width = 5, line_width = 5, type = "plotly") |>
  add_trace(
  type = "cone",
  x = ym1,
  y = xm1,
  ...
  cmax = 1
    ...
    add_trace(data = DF,
            ...
            type = "scatter3d",
            mode = "lines",  
            line = list(color = "rgb(0,0,200)", width = 5),
            showlegend = FALSE) |>
...
```{r, eval =TRUE, fig.height = 7, out.width = "100%", fig.cap = captioner("Function $f'' = \\{f''_e\\}_{e\\in\\mathcal{E}}$ given by $f_{e_i}''(s) = -\\dfrac{2 b_i s}{\\ell^2}$ for $i=1,2,3$.")}
graph$plot_function(X = ddf, vertex_size = 5, edge_width = 5, line_width = 5, continuous = TRUE, interpolate_plot = TRUE, type = "plotly") |> 
  add_trace(
  type = "cone",
  x = ym1,
  y = xm1,
...
```{r, eval =TRUE, fig.height = 7, out.width = "100%", fig.cap = captioner("Function $f''' = \\{f'''_e\\}_{e\\in\\mathcal{E}}$ given by $f_{e_i}'''(s) = -\\dfrac{2 b_i}{\\ell^2}$ for $i=1,2,3$.")}
graph_disc$plot_function(X = dddf, vertex_size = 5, edge_width = 5, line_width = 5, continuous = FALSE, interpolate_plot = TRUE, type = "plotly") |> 
  add_trace(
  type = "cone",
  x = ym1,
  y = xm1,
...
graph$plot_function(X = g, vertex_size = 5, edge_width = 5, line_width = 5, type = "plotly") |> 
  config(mathjax = 'cdn') |>
  add_trace(
  type = "cone",
  x = ym1,
...
```{r, eval =TRUE, fig.height = 7, out.width = "100%", fig.cap = captioner("Function $g' = \\{g'_e\\}_{e\\in\\mathcal{E}}$ given by $g_{e_i}'(s) = -\\dfrac{\\pi}{\\ell}\\sin(\\dfrac{\\pi s}{\\ell})$ for $i=1,2,3$.")}
graph$plot_function(X = dg, vertex_size = 5, edge_width = 5, line_width = 5, type = "plotly") |> 
  config(mathjax = 'cdn') |>
  add_trace(
  type = "cone",
  x = ym1,
...
```{r, eval =TRUE, fig.height = 7, out.width = "100%", fig.cap = captioner("Function $g'' = \\{g''_e\\}_{e\\in\\mathcal{E}}$ given by $g_{e_i}''(s) = -\\dfrac{\\pi^2}{\\ell^2}\\cos(\\dfrac{\\pi s}{\\ell})$ for $i=1,2,3$.")}
graph$plot_function(X = ddg, vertex_size = 5, edge_width = 5, line_width = 5, type = "plotly") |> 
  config(mathjax = 'cdn') |>
  add_trace(
  type = "cone",
  x = ym1,
...
```{r, eval =TRUE, fig.height = 7, out.width = "100%", fig.cap = captioner("Function $g''' = \\{g'''_e\\}_{e\\in\\mathcal{E}}$ given by $g_{e_i}'''(s) = \\dfrac{\\pi^3}{\\ell^3}\\sin(\\dfrac{\\pi s}{\\ell})$ for $i=1,2,3$.")}
graph$plot_function(X = dddg, vertex_size = 5, edge_width = 5, line_width = 5, type = "plotly") |> 
  config(mathjax = 'cdn') |>
  add_trace(
  type = "cone",
  x = ym1,
...
```{r, eval =TRUE, fig.height = 7, out.width = "100%", fig.cap = captioner("Function $f = \\{f_e\\}_{e\\in\\mathcal{E}}$ given by $f_{e_i}(s) = a + b_i s - \\dfrac{b_i s^3}{3\\ell^2}$ for $i=1,2$.")}
graph$plot_function(X = f, vertex_size = 5, edge_width = 5, line_width = 5, type = "plotly") |> 
  config(mathjax = 'cdn') |>
  add_trace(
  type = "cone",
...
```{r, eval =TRUE, fig.height = 7, out.width = "100%", fig.cap = captioner("Function $f' = \\{f'_e\\}_{e\\in\\mathcal{E}}$ given by $f_{e_i}'(s) = b_i - \\dfrac{b_i s^2}{\\ell^2}$ for $i=1,2$.")}
graph$plot_function(X = f*0, vertex_size = 5, line_color = "black", edge_width = 5, line_width = 5, type = "plotly") |>
  add_trace(
  type = "cone",
  x = ym1,
