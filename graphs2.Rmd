...
```{r, eval = FALSE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $f' = \\{f'_e\\}_{e\\in\\mathcal{E}}$ given by $f_{e_i}'(s) = b_i - \\dfrac{b_i s^2}{\\ell^2}$ for $i=1,2,3$.")}
...
```{r}
save_plotly_figure_fixed(star3f, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(star3df, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(star3ddf, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(star3dddf, dpi = 600,  scale = 2, viewer_change = 1)

png_files <- c("/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star3f.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star3df.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star3ddf.png")
output_file <- "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star3f_star3df_star3ddf.png"
...
:::: {style="display: grid; grid-template-columns: 600px 600px 600px 600px; grid-column-gap: 0px;"}


::: {}

```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $f = \\{f_e\\}_{e\\in\\mathcal{E}}$ given by $f_{e_i}(s) = a + b_i s - \\dfrac{b_i s^3}{3\\ell^2}$ for $i=1,2,3$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star3f.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $f' = \\{f'_e\\}_{e\\in\\mathcal{E}}$ given by $f'_{e_i}(s) = b_i - \\dfrac{b_i s^2}{\\ell^2}$ for $i=1,2,3$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star3df.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $f'' = \\{f''_e\\}_{e\\in\\mathcal{E}}$ given by $f''_{e_i}(s) = -\\dfrac{2 b_i s}{\\ell^2}$ for $i=1,2,3$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star3ddf.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $f''' = \\{f'''_e\\}_{e\\in\\mathcal{E}}$ given by $f'''_{e_i}(s) = -\\dfrac{2 b_i}{\\ell^2}$ for $i=1,2,3$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star3dddf.png"))
```
...
```{r}
save_plotly_figure_fixed(star3g, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(star3dg, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(star3ddg, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(star3dddg, dpi = 600,  scale = 2, viewer_change = 1)

png_files <- c("/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star3g.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star3dg.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star3ddg.png")
output_file <- "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star3g_star3dg_star3ddg.png"
...
```{r}
save_plotly_figure_fixed(star3dg_path1, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(star3dg_path2, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(star3dg_path3, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(star3dg_path_ok, dpi = 600,  scale = 2, viewer_change = 1)

png_files <- c("/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star3dg_path1.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star3dg_path2.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star3dg_path3.png")
output_file <- "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star3dg_path1_star3dg_path2_star3dg_path3.png"
...
```{r}
save_plotly_figure_fixed(star3ddg_path1, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(star3ddg_path2, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(star3ddg_path3, dpi = 600,  scale = 2, viewer_change = 1)

png_files <- c("/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star3ddg_path1.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star3ddg_path2.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star3ddg_path3.png")
output_file <- "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star3ddg_path1_star3ddg_path2_star3ddg_path3.png"
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $g = \\{g_e\\}_{e\\in\\mathcal{E}}$ given by $g_{e_i}(s) = \\cos(\\dfrac{\\pi s}{\\ell})$ for $i=1,2,3$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star3g.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $g' = \\{g'_e\\}_{e\\in\\mathcal{E}}$ given by $g'_{e_i}(s) = -\\dfrac{\\pi}{\\ell}\\sin(\\dfrac{\\pi s}{\\ell})$ for $i=1,2,3$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star3dg.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $g'' = \\{g''_e\\}_{e\\in\\mathcal{E}}$ given by $g''_{e_i}(s) = -\\dfrac{\\pi^2}{\\ell^2}\\cos(\\dfrac{\\pi s}{\\ell})$ for $i=1,2,3$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star3ddg.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $g''' = \\{g'''_e\\}_{e\\in\\mathcal{E}}$ given by $g'''_{e_i}(s) = \\dfrac{\\pi^3}{\\ell^3}\\sin(\\dfrac{\\pi s}{\\ell})$ for $i=1,2,3$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star3dddg.png"))
```
...
```{r}
save_plotly_figure_fixed(star2f, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(star2df, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(star2ddf, dpi = 600,  scale = 2, viewer_change = 1)
save_plotly_figure_fixed(star2dddf, dpi = 600,  scale = 2, viewer_change = 1)

png_files <- c("/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star2f.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star2df.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star2ddf.png")
output_file <- "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/star2f_star2df_star2ddf.png"
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $h = \\{h_e\\}_{e\\in\\mathcal{E}}$ given by $h_{e_i}(s) = a + b_i s - \\dfrac{b_i s^3}{3\\ell^2}$ for $i=1,2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star2f.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $h' = \\{h'_e\\}_{e\\in\\mathcal{E}}$ given by $h'_{e_i}(s) = b_i - \\dfrac{b_i s^2}{\\ell^2}$ for $i=1,2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star2df.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $h'' = \\{h''_e\\}_{e\\in\\mathcal{E}}$ given by $h''_{e_i}(s) =  - \\dfrac{2 b_i s}{\\ell^2}$ for $i=1,2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star2ddf.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $h''' = \\{h'''_e\\}_{e\\in\\mathcal{E}}$ given by $h'''_{e_i}(s) =  - \\dfrac{2 b_i}{\\ell^2}$ for $i=1,2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star2dddf.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $h = \\{h_e\\}_{e\\in\\mathcal{E}}$ given by $h_{e_i}(s) = a + b_i s - \\dfrac{b_i s^3}{3\\ell^2}$ for $i=1,2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star3dg_path1.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $h' = \\{h'_e\\}_{e\\in\\mathcal{E}}$ given by $h'_{e_i}(s) = b_i - \\dfrac{b_i s^2}{\\ell^2}$ for $i=1,2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star3dg_path2.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $h'' = \\{h''_e\\}_{e\\in\\mathcal{E}}$ given by $h''_{e_i}(s) =  - \\dfrac{2 b_i s}{\\ell^2}$ for $i=1,2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star3dg_path3.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $h'' = \\{h''_e\\}_{e\\in\\mathcal{E}}$ given by $h''_{e_i}(s) =  - \\dfrac{2 b_i s}{\\ell^2}$ for $i=1,2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star3dg_path_ok.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $h = \\{h_e\\}_{e\\in\\mathcal{E}}$ given by $h_{e_i}(s) = a + b_i s - \\dfrac{b_i s^3}{3\\ell^2}$ for $i=1,2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star3ddg_path1.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $h' = \\{h'_e\\}_{e\\in\\mathcal{E}}$ given by $h'_{e_i}(s) = b_i - \\dfrac{b_i s^2}{\\ell^2}$ for $i=1,2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star3ddg_path2.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Function $h'' = \\{h''_e\\}_{e\\in\\mathcal{E}}$ given by $h''_{e_i}(s) =  - \\dfrac{2 b_i s}{\\ell^2}$ for $i=1,2$.")}
knitr::include_graphics(here::here("data_files/plotlypdf/star3ddg_path3.png"))
```
