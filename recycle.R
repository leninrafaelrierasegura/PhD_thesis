...
## This animates graph into intervals
...
p <- p |>
  ...
  layout(font = list(family = "Palatino"),
         margin = list(l = 0, r = 0, b = 0, t = 0),
         scene = list(xaxis = list(title = list(text = "x", font = list(color = "gray", size = 16)),  tickfont = list(color = "gray", size = 13),  range = c(0, x_shift_for_circle +2*radius)*1.01),
                      yaxis = list(title = list(text = "y", font = list(color = "gray", size = 16)),  tickfont = list(color = "gray", size = 13), range = range(int_map_circle$y)),
                      zaxis = list(title = list(text = "z", font = list(color = "gray", size = 16)),  tickfont = list(color = "gray", size = 13), range = c(0, y_up_range+1)),
                      aspectratio = list(x = x_shift_for_circle +2*radius, y = L, z = 4),
...
# 🔴 STATIC smooth curves (always visible)
p <- p |>
  add_trace(
    data = rbind(
      curve_smooth,
