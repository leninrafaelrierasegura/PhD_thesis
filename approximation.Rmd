  ...
  layout(font = list(family = "Palatino"),
         scene = list(xaxis = list(title = list(text = "x", font = list(color = "gray", size = 20)),  tickfont = list(color = "gray", size = 15)),
           ...
           annotations = list(
             ...
             list(
               x = 0, y = 0, z = 1.3,
               text = TeX("\\bullet\\mbox{ exact}\\phantom{exact}"),
               textangle = 0, ax = 60, ay = 0,
               font = list(color = "#0000C8", size = 15),
               arrowcolor = "rgba(0,0,0,0)"),
             list(
               x = 0, y = 0, z = 1.2,
...
save_plotly_figure_fixed(p_int, dpi = 600,  scale = 2, viewer_change = 1)
```
...
save_plotly_figure_fixed(p_cir, dpi = 600,  scale = 2, viewer_change = 1)
```
...
save_plotly_figure_fixed(p_tad, dpi = 600,  scale = 2, viewer_change = 1)
```
...
```{r}
png_files <- c("/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p_int.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p_cir.png",
               "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p_tad.png")
output_file <- "/home/rierasl/Desktop/PhD_thesis/data_files/plotlypdf/p_int_p_cir_p_tad.png"
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Exact and approximated covariance function on the interval graph.")}
knitr::include_graphics(here::here("data_files/plotlypdf/p_int.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Exact and approximated covariance function on the circle graph.")}
knitr::include_graphics(here::here("data_files/plotlypdf/p_cir.png"))
```
...
```{r, eval =TRUE, fig.height = 7, out.width = "70%", fig.cap = captioner("Exact and approximated covariance function on the tadpole graph.")}
knitr::include_graphics(here::here("data_files/plotlypdf/p_tad.png"))
```
